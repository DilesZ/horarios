...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    points: "10 9 9 9 8 9"
  })), exportPanelExpanded ? "Cerrar exportación" : "Exportar"), /*#__PURE__*/React.createElement("div", {
    ...
    className: `rounded-md px-3 py-2 text-sm font-medium transition-colors ${viewMode === option.key ? "bg-fuchsia-600 text-white shadow-sm" : "text-gray-600 hover:bg-gray-100"}`
