    ...
    dailyCoverage.forEach(d => {
      ...
      if (need18h && !d.group1HasOffice) {
        ...
        reasons.push({
          ...
          detail: isCovered ? `Ningún miembro del grupo está en oficina, pero el otro grupo cubre: ${d.group2Covering.join(", ")}.` : `Ningún miembro del grupo está en oficina con turno completo.`,
      ...
      if (need18h && !d.group2HasOffice) {
        ...
        reasons.push({
          ...
          detail: isCovered ? `Ningún miembro del grupo está en oficina, pero el otro grupo cubre: ${d.group1Covering.join(", ")}.` : `Ningún miembro del grupo está en oficina con turno completo.`,
          context: contextParts.length > 0 ? contextParts.join(" · ") : null,
          icon: isCovered ? "check" : "group"
        });
      }
